...
for i in range(len(list_feature)):
  for letter2State in list_state:
    ...
    pathOutput = 'OUTPUT/DyGrEncoder/'+letter2State+'/'+FEATURES+'/'
    #%% Open Datasets
    ...
    class RecurrentGCN(torch.nn.Module):  
        def __init__(self, node_features):  
            ...
            self.recurrent = DyGrEncoder(conv_out_channels=node_features, conv_num_layers=1, conv_aggr="mean", lstm_out_channels=128, lstm_num_layers=1)
